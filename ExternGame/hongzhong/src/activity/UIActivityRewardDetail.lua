local uiActivityRewardDetail = class("uiActivityRewardDetail", ex_fileMgr:loadLua("packages.mvc.ViewBase"))

uiActivityRewardDetail.RESOURCE_FILENAME = "activity2/uiActivityRewardDetail.csb"
uiActivityRewardDetail.RESOURCE_BINDING = {
...
uiActivityRewardDetail.KEY_FOR = {
	-- [] = ""
}

function uiActivityRewardDetail:onCreate()
    cclog("CREATE")
...
function uiActivityRewardDetail:onEnter()
    cclog("ENTER")
...
function uiActivityRewardDetail:onExit()
    cclog("EXIT")
    CCXNotifyCenter:unListenByObj(self)
end

function uiActivityRewardDetail:setClubData( data )
	cclog(" -- uiActivityRewardDetail ")
	print_r(data)
	self.data = data
...
function uiActivityRewardDetail:checkClubDetail()
...
function uiActivityRewardDetail:setFudaiNum(fudainum)
    self.fudainum = fudainum
    self.txt_fudainum:setString(fudainum or 0)
end


function uiActivityRewardDetail:onActivityRewardDetail(data)
	if data then 
		self:normalUI()
...
function uiActivityRewardDetail:normalUI()
	for i=1,3 do
...
function uiActivityRewardDetail:setTaskData(data)
...
function uiActivityRewardDetail:setRankData(data)
	--排序
...
function uiActivityRewardDetail:onBack()
    cclog("-------onBack")
    self:removeFromParent()
end

function uiActivityRewardDetail:onCloseAll()
	CCXNotifyCenter:notify("ActivitysCloseAll")
end

function uiActivityRewardDetail:onLottery()
...
function uiActivityRewardDetail:onMyRes()
...
function uiActivityRewardDetail:onRanks()
