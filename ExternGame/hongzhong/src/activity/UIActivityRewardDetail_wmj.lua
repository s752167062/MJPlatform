local uiActivityRewardDetail_wmj = class("uiActivityRewardDetail_wmj", ex_fileMgr:loadLua("packages.mvc.ViewBase"))

uiActivityRewardDetail_wmj.RESOURCE_FILENAME = "activity2/uiActivityRewardDetail_wmj.csb"
uiActivityRewardDetail_wmj.RESOURCE_BINDING = {
...
uiActivityRewardDetail_wmj.KEY_FOR = {
	-- [] = ""
}

function uiActivityRewardDetail_wmj:onCreate()
    cclog("CREATE")
...
function uiActivityRewardDetail_wmj:onEnter()
    cclog("ENTER")
...
function uiActivityRewardDetail_wmj:onExit()
    cclog("EXIT")
    CCXNotifyCenter:unListenByObj(self)
end

function uiActivityRewardDetail_wmj:setClubData( data )
	cclog(" -- uiActivityRewardDetail_wmj ")
	print_r(data)
	self.data = data
...
function uiActivityRewardDetail_wmj:checkClubDetail()
...
function uiActivityRewardDetail_wmj:setFudaiNum(fudainum)
    self.fudainum = fudainum
    self.txt_fudainum:setString(fudainum or 0)
end


function uiActivityRewardDetail_wmj:onActivityRewardDetail(data)
	if data then 
		self:normalUI()
...
function uiActivityRewardDetail_wmj:normalUI()
	for i=1,3 do
...
function uiActivityRewardDetail_wmj:setTaskData(data)
...
function uiActivityRewardDetail_wmj:setRankData(data)
	--排序
...
function uiActivityRewardDetail_wmj:onBack()
    cclog("-------onBack")
    self:removeFromParent()
end

function uiActivityRewardDetail_wmj:onCloseAll()
	CCXNotifyCenter:notify("ActivitysCloseAll")
end

function uiActivityRewardDetail_wmj:onLottery()
...
function uiActivityRewardDetail_wmj:onMyRes()
...
function uiActivityRewardDetail_wmj:onRanks()
...
return uiActivityRewardDetail_wmj
