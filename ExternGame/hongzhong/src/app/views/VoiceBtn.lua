local VoiceBtn = class("VoiceBtn", ex_fileMgr:loadLua("packages.mvc.ViewBase"))

VoiceBtn.RESOURCE_FILENAME = "VoiceBtn.csb"
VoiceBtn.RESOURCE_BINDING = {
    ["btn_mcrophone"]       = {    ["varname"] = "btn_mcrophone"     },
}

function VoiceBtn:onCreate()
