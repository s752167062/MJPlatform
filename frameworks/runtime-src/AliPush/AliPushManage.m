...
static AliPushManage* instance = NULL;

#ifdef IPHONE_INHOUS
//使用于湖南企业包 com.qupai.hnmj1
NSString *pushAppKey = @"24706524";
NSString *pushAppSecret = @"e20a530b43903c22db2b284154b364bf";
#else
////使用于IOS提示包 com.qupai.hnmajiang1
NSString *pushAppKey = @"24715048";
NSString *pushAppSecret = @"fe5ac569f22b41d745b7fafecc7ec018";
#endif
...
+(AliPushManage*) getInstance{
    if (instance == NULL) {
        instance = [[AliPushManage alloc] init];
    }
    return instance;
}
