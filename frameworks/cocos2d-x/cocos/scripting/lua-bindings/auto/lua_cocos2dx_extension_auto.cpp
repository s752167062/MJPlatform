...
int lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_count(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_count'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_count'", nullptr);
            return 0;
        }
        int ret = cobj->get_zip_files_count();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.EventAssetsManagerEx:get_zip_files_count",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_count'.",&tolua_err);
#endif
    
    return 0;
}

int lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_tatal(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_tatal'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_tatal'", nullptr);
            return 0;
        }
        int ret = cobj->get_zip_files_tatal();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.EventAssetsManagerEx:get_zip_files_tatal",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_tatal'.",&tolua_err);
#endif
    
    return 0;
}

int lua_cocos2dx_extension_EventAssetsManagerEx_get_cur_zip_count(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_cur_zip_count'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_cur_zip_count'", nullptr);
            return 0;
        }
        int ret = cobj->get_cur_zip_count();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.EventAssetsManagerEx:get_cur_zip_count",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_cur_zip_count'.",&tolua_err);
#endif
    
    return 0;
}

int lua_cocos2dx_extension_EventAssetsManagerEx_get_total_zip_count(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_total_zip_count'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_total_zip_count'", nullptr);
            return 0;
        }
        int ret = cobj->get_total_zip_count();
        tolua_pushnumber(tolua_S,(lua_Number)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.EventAssetsManagerEx:get_total_zip_count",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_total_zip_count'.",&tolua_err);
#endif
    
    return 0;
}

int lua_cocos2dx_extension_EventAssetsManagerEx_get_unzip_filename(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::EventAssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_unzip_filename'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_unzip_filename'", nullptr);
            return 0;
        }
        std::string ret = cobj->get_unzip_filename();
        tolua_pushcppstring(tolua_S,ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.EventAssetsManagerEx:get_unzip_filename",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_EventAssetsManagerEx_get_unzip_filename'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_extension_EventAssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EventAssetsManagerEx");
        ...
        tolua_function(tolua_S,"get_zip_files_count",lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_count);
        tolua_function(tolua_S,"get_zip_files_tatal",lua_cocos2dx_extension_EventAssetsManagerEx_get_zip_files_tatal);
        tolua_function(tolua_S,"get_cur_zip_count",lua_cocos2dx_extension_EventAssetsManagerEx_get_cur_zip_count);
        tolua_function(tolua_S,"get_total_zip_count",lua_cocos2dx_extension_EventAssetsManagerEx_get_total_zip_count);
        tolua_function(tolua_S,"get_unzip_filename",lua_cocos2dx_extension_EventAssetsManagerEx_get_unzip_filename);
...
//======================================================================
int lua_cocos2dx_extension_AssetsManagerEx_updateFinish(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::extension::AssetsManagerEx* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_extension_AssetsManagerEx_updateFinish'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_extension_AssetsManagerEx_updateFinish'", nullptr);
            return 0;
        }
        cobj->updateFinish();
        lua_settop(tolua_S, 1);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.AssetsManagerEx:updateFinish",argc, 0);
    return 0;
    
#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_extension_AssetsManagerEx_updateFinish'.",&tolua_err);
#endif
...
int lua_cocos2dx_extension_AssetsManagerEx_constructor(lua_State* tolua_S)
{
    ...
    if (argc == 3) 
    {
        ...
        cobj = new cocos2d::extension::AssetsManagerEx(arg0, arg1, arg2);
        cobj->autorelease();
        int ID =  (int)cobj->_ID ;
        int* luaID =  &cobj->_luaID ;
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.AssetsManagerEx:AssetsManagerEx",argc, 3);
    return 0;
...
int lua_register_cocos2dx_extension_AssetsManagerEx(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"AssetsManagerEx");
        ...
        tolua_function(tolua_S,"updateFinish",lua_cocos2dx_extension_AssetsManagerEx_updateFinish);
